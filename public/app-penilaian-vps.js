...
async function loadInputNilaiDiniyyah(){
  ...
  $('main').innerHTML=`<div class="page-header fade-up"><h2><i class="ri-award-line"></i> Penilaian Madrasah Diniyyah</h2>
    ...
    <div class="card fade-up"><div style="display:flex;gap:.8rem;flex-wrap:wrap;align-items:end">
      ...
      <div class="fg" style="flex:1;min-width:100px"><label>Semester</label><input id="nilaiSmt" value="${defSmt}" placeholder="2026-1"></div>
...
async function loadRaportPenilaian(kategori = 'semua'){
  ...
  $('main').innerHTML=`<div class="page-header fade-up">
    ...
    <div class="card fade-up"><div style="display:flex;gap:.8rem;flex-wrap:wrap;align-items:end">
      ...
      ${kategori!=='kegiatan'?`<div class="fg" style="flex:1;min-width:120px"><label>Semester</label><input id="rpSemester" value="${yr}-${sem}" placeholder="2025-1"></div>`:''}
...
// ═══════════════════════════════════════════════════════════
async function showPengaturanRaport(kategori){
  ...
  $('modal').innerHTML = `
    ...
    <div style="display:flex;gap:.5rem;margin-top:1.5rem">
      <button class="btn btn-primary" onclick="savePengaturanRaport('${kategori}')"><i class="ri-save-line"></i> Simpan</button>
...
async function savePengaturanRaport(kategori){
  const body = {};
...
function uploadTtd(kategori, body) {
