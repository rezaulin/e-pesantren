...
premium_logic = """// -- Admin Dashboard (SIPP Style) --
  ...
  <div class="hide-on-mobile" id="dashPerhatianArea"></div>

  ${jadwalHtml}
  `;
  startDashClock();
  if(typeof loadDashPerhatian === 'function') loadDashPerhatian();
}
"""
...
print("Premium JS updated for PC vs Mobile logic.")
